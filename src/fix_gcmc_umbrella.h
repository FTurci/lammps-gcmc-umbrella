...
#ifdef FIX_CLASS
// clang-format off
FixStyle(gcmc/umbrella,FixGCMCUmbrella);
// clang-format on
#else

#ifndef LMP_FIX_GCMC_UMBRELLA_H
#define LMP_FIX_GCMC_UMBRELLA_H

#include "fix.h"

namespace LAMMPS_NS {

class FixGCMCUmbrella : public Fix {
 public:
  FixGCMCUmbrella(class LAMMPS *, int, char **);
  ~FixGCMCUmbrella() override;
 ...
 private:
  ...
  // FT Umbrella parameters
  double k;    // spring constant
  int n0;      // number of atoms at teh centre of the umbrella
  // END FT
